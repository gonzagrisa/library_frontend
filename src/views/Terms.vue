<template>
	<v-app>
		<div id="terms">
			<h1 id="title">Términos y Condiciones de Uso</h1>

			<h2 class="subtitle">Información General</h2>

			<p>Este sitio web es operado por Bookjar. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Bookjar. Bookjar ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
			...
			<h2 class="subtitle">SECCIÓN 1 - TÉRMINOS DE LA TIENDA EN LÍNEA</h2>
			...
			<h2 class="subtitle">SECCIÓN 2 - CONDICIONES GENERALES</h2>
			...
			<h2 class="subtitle">SECCIÓN 3 - EXACTITUD, EXHAUSTVIDAD Y ACTUALIDAD DE LA INFORMACIÓN</h2>
			...
			<h2 class="subtitle">SECCIÓN 4 - MODIFICACIONES AL SERVICIO Y PRECIOS</h2>
			...
			<h2 class="subtitle">SECCIÓN 5 - PRODUCTOS O SERVICIOS (si aplicable)</h2>
			...
			<h2 class="subtitle">SECCIÓN 6 - EXACTITUD DE FACTURACIÓN E INFORMACIÓN DE CUENTA</h2>
			...
			<h2 class="subtitle">SECCIÓN 7 - HERRAMIENTAS OPCIONALES</h2>
			...
			<h2 class="subtitle">SECCIÓN 8 - ENLACES DE TERCERAS PARTES</h2>
			...
			<h2 class="subtitle">SECCIÓN 9 - COMENTARIOS DE USUARIO, CAPTACIÓN Y OTROS ENVÍOS</h2>
			...
			<h2 class="subtitle">SECCIÓN 10 - INFORMACIÓN PERSONAL</h2>
			...
			<h2 class="subtitle">SECCIÓN 11 - ERRORES, INEXACTITUDES Y OMISIONES</h2>
			...
			<h2 class="subtitle">SECCIÓN 12 - USOS PROHIBIDOS</h2>
			...
			<h2 class="subtitle">SECCIÓN 13 - EXCLUSIÓN DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD</h2>
			...
			<h2 class="subtitle">SECCIÓN 16 - RESCISIÓN</h2>
			...
			<h2 class="subtitle">SECCIÓN 17 - ACUERDO COMPLETO</h2>
			...
			<h2 class="subtitle">SECCIÓN 18 - LEY</h2>

			<p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Bv. Chacabuco 800, Córdoba, X, 5000, Argentina.</p>

			<h2 class="subtitle">SECCIÓN 19 - CAMBIOS EN LOS TÉRMINOS DE SERVICIO</h2>
			...
			<h2 class="subtitle">SECCIÓN 20 - INFORMACIÓN DE CONTACTO</h2>

			<p>Preguntas acerca de los Términos de Servicio deben ser enviadas a bookjar@gmail.com.</p>
		</div>
<!-- 		<h1 class="display-4 mx-auto">PUTO EL QUE LEE</h1>
		<img src="https://media.giphy.com/media/IbOOT0ieWujtBDghfj/giphy.gif" />
		<img src="https://media.giphy.com/media/dy48sfSsn6uoJEtHu4/giphy.gif" />
		<img class="mx-auto" src="https://pbs.twimg.com/media/ECgq6ErXYAEXWxd.jpg" width="1000px" /> -->
	</v-app>
</template>
